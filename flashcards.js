  ...
  inquirer.prompt([                            //use inquirer to ask question
      {
          ...
          choices: ["Create", "Use All", "Random",  "Show All", "Exit"],  //options that show in list
    ...
    inquirer.prompt([
        ...
        if (cardType === "Basic Card") {
            inquirer.prompt([
                ...
                fs.writeFile("cardLibrary.json", JSON.stringify(library, null, 2)); //write the updated array to 
                                                                                    // the carLibrary.json file
